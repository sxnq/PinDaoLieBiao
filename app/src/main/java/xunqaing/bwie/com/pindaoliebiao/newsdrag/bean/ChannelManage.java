package xunqaing.bwie.com.pindaoliebiao.newsdrag.bean;
...
import xunqaing.bwie.com.pindaoliebiao.newsdrag.dao.ChannelDao;
...
public class ChannelManage {
	...
	static {
		...
		defaultUserChannels.add(new ChannelItem(7, "QQ影音", 7, 1));
		defaultUserChannels.add(new ChannelItem(8, "微信", 8, 1));
